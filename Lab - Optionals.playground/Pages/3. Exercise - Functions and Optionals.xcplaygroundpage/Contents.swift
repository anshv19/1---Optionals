...
var prices = ["Chips": 2.5, "Donuts": 1.67, "Juice": 3.99, "Apple": 7.50, "Banana": 0.75, "Broccoli": 0.89]
var stock = ["Chips": 6, "Donuts": 0, "Juice": 18, "Apple": 5, "Banana": 4, "Broccoli": 3]

func checkStock(name: String) -> Double? {
    if let availableStock = stock[name], availableStock > 0 {
        return prices[name]
    } else {
        return nil
    }
