...
func getMealLog(mealName: String) -> Meal? {
    return meals[mealName]
}

if let breakfast = getMealLog(mealName: "Breakfast") {
    print("Breakfast log found:")
    print("Foods: \(breakfast.food)")
    print("Calories: \(breakfast.calories)")
} else {
    print("No log found for Breakfast.")
}
/*:
